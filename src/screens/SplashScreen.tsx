...
const styles = StyleSheet.create({
  container: { flex: 1 },
  hero: {
    flex: 1, alignItems: 'center', justifyContent: 'center', gap: 18, paddingHorizontal: 24,
  },
  title: {
    fontFamily: BN.display, fontSize: 44, color: '#fff',
    letterSpacing: 3, lineHeight: 44, marginTop: 4,
  },
  tagline: {
    fontFamily: BN.ui, fontSize: 14, fontStyle: 'italic',
